#!/bin/bash
#SBATCH --job-name=train_v3_file # Job name
...
MODEL_CONFIG_YAML="/home/hice1/yzhang3942/scratch/llm-guided-evolution/sota/ultralytics/ultralytics/cfg/models/v3/yolov3.yaml"
...
# --- Environment Setup ---
echo "This is the actual v3 50 epoch run(for real, I had to set to train2/weights/last.pt)"
hostname
...
echo "Resuming yolov3 (50 epochs)!"
